module github.com/alethialabs-io/alethialabs/apps/cli
...
replace (
	github.com/alethialabs-io/alethialabs/apps/runner => ../../apps/runner
	github.com/alethialabs-io/alethialabs/packages/core => ../../packages/core
)
